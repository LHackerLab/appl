...
import fusionsoftware.loop.appl.locker.lock.AppLockService;
import fusionsoftware.loop.appl.locker.lock.LockService;
import fusionsoftware.loop.appl.locker.util.PrefUtils;
import fusionsoftware.loop.appl.util.DialogSequencer;
...
//			: VERSION_URL_PRD;
    private static final String EXTRA_UNLOCKED = "fusionsoftware.loop.appl";
